...
C_SRCS += \
../Libraries/Bsp/Assert.c 

OBJS += \
./Libraries/Bsp/Assert.o 

COMPILED_SRCS += \
./Libraries/Bsp/Assert.src 

C_DEPS += \
./Libraries/Bsp/Assert.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/Bsp/%.src: ../Libraries/Bsp/%.c Libraries/Bsp/subdir.mk
	@echo 'Building file: $<'
...
Libraries/Bsp/%.o: ./Libraries/Bsp/%.src Libraries/Bsp/subdir.mk
	@echo 'Building file: $<'
