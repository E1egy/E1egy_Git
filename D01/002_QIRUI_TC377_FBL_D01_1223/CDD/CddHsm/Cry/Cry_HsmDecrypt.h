...
#ifndef CRY_HSM_DECRYPT_H
#define CRY_HSM_DECRYPT_H
/******************************************************************************
**                      Includes                                             **
******************************************************************************/
...
typedef Cry_HsmBasicConfigType Cry_HsmDecryptConfigType;

extern Cry_HsmDecryptConfigType  Cry_HsmDecryptConfig;
...
extern Csm_ReturnType  Cry_HsmDecrypt(const void *CfgPtr,const Csm_SymKeyType *KeyPtr,const uint8 *IV,Hsm_CipherAlgorithmType Algorithm_Type,
