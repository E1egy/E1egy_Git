...
#define SHE_DELIVERY_TYPE              (PRE_COMPILE_DELIVERY)



#define MCU_DELIVERY                   (STD_OFF)
#define PORT_DELIVERY                  (STD_OFF)
#define DIO_DELIVERY                   (STD_OFF)
#define GTM_DELIVERY                   (STD_OFF)
#define GPT_DELIVERY                   (STD_OFF)
#define SPI_DELIVERY                   (STD_OFF)
#define SPI_SLAVE_DELIVERY             (STD_OFF)
#define PWM_DELIVERY                   (STD_OFF)
#define ADC_DELIVERY                   (STD_OFF)
...
#define ICU_DELIVERY                   (STD_OFF)
#define ERU_DELIVERY                   (STD_OFF)
#define CAN_DELIVERY                   (STD_OFF)
