...
* $Class_____: C$
* $Name______: UserTestTaskCore2.c$
* $Variant___: 1.0.1$
* $Revision__: 0$
* $Author____: YM$
**
...
uint32 UserTestCodeCore2_InitFlag = 0U;
uint32 UserTestCodeCore2_10msCnt = 0U;
...
***********************************************************************************************************************/
void UserTestTaskCore2_Init(void)
{
	UserTestCodeCore2_InitFlag = 1U;
...
***********************************************************************************************************************/
void UserTestTaskCore2_10Ms(void)
{
	UserTestCodeCore2_10msCnt++;
