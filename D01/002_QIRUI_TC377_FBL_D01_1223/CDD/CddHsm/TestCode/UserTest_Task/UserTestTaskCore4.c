...
* $Class_____: C$
* $Name______: UserTestTaskCore4.c$
* $Variant___: 1.0.1$
* $Revision__: 0$
* $Author____: YM$
**
...
uint32 UserTestCodeCore4_InitFlag = 0U;
uint32 UserTestCodeCore4_10msCnt = 0U;
...
***********************************************************************************************************************/
void UserTestTaskCore4_Init(void)
{
	UserTestCodeCore4_InitFlag = 1U;
...
***********************************************************************************************************************/
void UserTestTaskCore4_10Ms(void)
{
	UserTestCodeCore4_10msCnt++;
