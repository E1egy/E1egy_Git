...
* $Class_____: C$
* $Name______: UserTestTaskCore1.c$
* $Variant___: 1.0.1$
* $Revision__: 0$
* $Author____: YM$
**
...
uint32 UserTestCodeCore1_InitFlag = 0U;
uint32 UserTestCodeCore1_10msCnt = 0U;
...
***********************************************************************************************************************/
void UserTestTaskCore1_Init(void)
{
	UserTestCodeCore1_InitFlag = 1U;
...
***********************************************************************************************************************/
void UserTestTaskCore1_10Ms(void)
{
	UserTestCodeCore1_10msCnt++;
