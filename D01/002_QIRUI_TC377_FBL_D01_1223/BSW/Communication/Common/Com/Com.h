...
#define COM_H_SW_PATCH_VERSION      1u
...
extern CONST(Com_ConfigType, COM_CONST_PBCFG)
Com_PBConfigData;
...
#include "Com_MemMap.h"
extern VAR(Com_RxIPduRunTimeStateType, COM_VAR)
Com_RxIPduRunTimeState[COM_RXIPDU_NUMBER];
#define COM_STOP_SEC_VAR_NO_INIT_UNSPECIFIED
#include "Com_MemMap.h"

#define COM_START_SEC_PBCONFIG_DATA_UNSPECIFIED
#include "Com_MemMap.h"
extern CONST(Com_RxIPduRunTimeStateType,COM_CONST)
...
#define COM_START_SEC_VAR_NO_INIT_UNSPECIFIED
#include "Com_MemMap.h"
extern VAR(Com_TxIPduRunTimeStateType, COM_VAR)
Com_TxIPduRunTimeState[COM_TXIPDU_NUMBER];
#define COM_STOP_SEC_VAR_NO_INIT_UNSPECIFIED
#include "Com_MemMap.h"

#define COM_START_SEC_PBCONFIG_DATA_UNSPECIFIED
#include "Com_MemMap.h"
extern CONST(Com_TxIPduRunTimeStateType,COM_CONST)
...
Com_TxIPduRuntimeBuff[COM_TXIPDUBUFF_SIZE];
...
#include "Com_MemMap.h"
extern VAR(uint8, COM_VAR)
Com_RxIPduRuntimeBuff[COM_RXIPDUBUFF_SIZE];
#define COM_STOP_SEC_VAR_NO_INIT_8
#include "Com_MemMap.h"
...
#include "Com_MemMap.h"
extern VAR(uint8, COM_VAR)
Com_Signal8BitRuntimeBuff[COM_SIGNAL_8BITBUFF_SIZE];
#define COM_STOP_SEC_VAR_NO_INIT_8
#include "Com_MemMap.h"
...
Com_Signal16BitRuntimeBuff[COM_SIGNAL_16BITBUFF_SIZE];
#define COM_STOP_SEC_VAR_NO_INIT_16
#include "Com_MemMap.h"

#define COM_START_SEC_PBCONFIG_DATA_16
#include "Com_MemMap.h"
extern CONST(uint16,COM_CONST)
...
#include "Com_MemMap.h"
extern VAR(uint32, COM_VAR)
Com_Signal32BitRuntimeBuff[COM_SIGNAL_32BITBUFF_SIZE];
#define COM_STOP_SEC_VAR_NO_INIT_32
#include "Com_MemMap.h"

#define COM_START_SEC_PBCONFIG_DATA_32
#include "Com_MemMap.h"
extern CONST(uint32,COM_CONST)
Com_Signal32BitInitValue[COM_SIGNAL_32BITBUFF_SIZE];
...
#include "Com_MemMap.h"
extern VAR(uint64, COM_VAR)
Com_Signal64BitRuntimeBuff[COM_SIGNAL_64BITBUFF_SIZE];
#define COM_STOP_SEC_VAR_NO_INIT_64
#include "Com_MemMap.h"

#define COM_START_SEC_PBCONFIG_DATA_64
#include "Com_MemMap.h"
extern CONST(uint64,COM_CONST)
Com_Signal64BitInitValue[COM_SIGNAL_64BITBUFF_SIZE];
...
#include "Com_MemMap.h"
extern VAR(boolean, COM_VAR)
Com_RxGroupSignalBoolShadowBuff[COM_RXGROUPSIGNAL_BOOLBUFF_SIZE];
#define COM_STOP_SEC_VAR_NO_INIT_BOOLEAN
#include "Com_MemMap.h"
#endif
...
#include "Com_MemMap.h"
extern VAR(uint8, COM_VAR)
Com_RxGroupSignal8BitShadowBuff[COM_RXGROUPSIGNAL_8BITBUFF_SIZE];
#define COM_STOP_SEC_VAR_NO_INIT_8
#include "Com_MemMap.h"
#endif
...
#include "Com_MemMap.h"
extern VAR(uint16, COM_VAR)
Com_RxGroupSignal16BitShadowBuff[COM_RXGROUPSIGNAL_16BITBUFF_SIZE];
#define COM_STOP_SEC_VAR_NO_INIT_16
#include "Com_MemMap.h"
#endif
...
#include "Com_MemMap.h"
extern VAR(uint32, COM_VAR)
Com_RxGroupSignal32BitShadowBuff[COM_RXGROUPSIGNAL_32BITBUFF_SIZE];
#define COM_STOP_SEC_VAR_NO_INIT_32
#include "Com_MemMap.h"
#endif
...
#include "Com_MemMap.h"
extern VAR(uint64, COM_VAR)
Com_RxGroupSignal64BitShadowBuff[COM_RXGROUPSIGNAL_64BITBUFF_SIZE];
#define COM_STOP_SEC_VAR_NO_INIT_64
#include "Com_MemMap.h"
#endif
...
#include "Com_MemMap.h"
extern VAR(boolean, COM_VAR)
Com_GWSignalBoolBuff[COM_GWSIGNAL_BOOLBUFF_SIZE];
#define COM_STOP_SEC_VAR_NO_INIT_BOOLEAN
#include "Com_MemMap.h"
#endif
...
#include "Com_MemMap.h"
extern VAR(uint8, COM_VAR)
Com_GWSignal8BitBuff[COM_GWSIGNAL_8BITBUFF_SIZE];
#define COM_STOP_SEC_VAR_NO_INIT_8
#include "Com_MemMap.h"
#endif
...
#include "Com_MemMap.h"
extern VAR(uint16, COM_VAR)
Com_GWSignal16BitBuff[COM_GWSIGNAL_16BITBUFF_SIZE];
#define COM_STOP_SEC_VAR_NO_INIT_16
#include "Com_MemMap.h"
#endif
...
#include "Com_MemMap.h"
extern VAR(uint32, COM_VAR)
Com_GWSignal32BitBuff[COM_GWSIGNAL_32BITBUFF_SIZE];
#define COM_STOP_SEC_VAR_NO_INIT_32
#include "Com_MemMap.h"
#endif
...
#include "Com_MemMap.h"
extern VAR(uint64, COM_VAR)
Com_GWSignal64BitBuff[COM_GWSIGNAL_64BITBUFF_SIZE];
#define COM_STOP_SEC_VAR_NO_INIT_64
#include "Com_MemMap.h"
#endif
...
#include "Com_MemMap.h"
extern VAR(boolean, COM_VAR)
TxSignalTMCRunTime[COM_TMCTXSIGNAL_NUMBER];
#define COM_STOP_SEC_VAR_NO_INIT_BOOLEAN
#include "Com_MemMap.h"
...
#include "Com_MemMap.h"
extern CONST(boolean,COM_CONST)
Com_TxSignalInitTMC[COM_TMCTXSIGNAL_NUMBER];
#define COM_STOP_SEC_PBCONFIG_DATA_BOOLEAN
#include "Com_MemMap.h"
#endif
...
#include "Com_MemMap.h"
extern VAR(boolean, COM_VAR)
TxGroupSignalTMCBuffer[COM_TMCTXGROUPSIGNAL_NUMBER];
#define COM_STOP_SEC_VAR_NO_INIT_BOOLEAN
#include "Com_MemMap.h"
#endif
...
#include "Com_MemMap.h"
extern CONST(boolean,COM_CONST)
Com_SignalBoolInvalidValue[COM_SIGNAL_BOOL_INVALID_SIZE];
#define COM_STOP_SEC_PBCONFIG_DATA_BOOLEAN
#include "Com_MemMap.h"
#endif
...
#include "Com_MemMap.h"
extern CONST(uint8,COM_CONST)
Com_Signal8BitInvalidValue[COM_SIGNAL_8BIT_INVALID_SIZE];
#define COM_STOP_SEC_PBCONFIG_DATA_8
#include "Com_MemMap.h"
#endif
...
#include "Com_MemMap.h"
extern CONST(uint16,COM_CONST)
Com_Signal16BitInvalidValue[COM_SIGNAL_16BIT_INVALID_SIZE];
#define COM_STOP_SEC_PBCONFIG_DATA_16
#include "Com_MemMap.h"
#endif
...
#include "Com_MemMap.h"
extern CONST(uint32,COM_CONST)
Com_Signal32BitInvalidValue[COM_SIGNAL_32BIT_INVALID_SIZE];
#define COM_STOP_SEC_PBCONFIG_DATA_32
#include "Com_MemMap.h"
#endif
...
#include "Com_MemMap.h"
extern CONST(uint64,COM_CONST)
Com_Signal64BitInvalidValue[COM_SIGNAL_64BIT_INVALID_SIZE];
#define COM_STOP_SEC_PBCONFIG_DATA_64
#include "Com_MemMap.h"
#endif
...
#include "Com_MemMap.h"
extern P2CONST (Com_ConfigType,COM_VAR,COM_CONST)
Com_ConfigStd;
...
#define COM_START_SEC_VAR_NO_INIT_UNSPECIFIED
#include "Com_MemMap.h"
extern VAR(Com_TxSignalGroupRunTimeStateType,COM_VAR)
