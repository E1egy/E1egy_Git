...
********************************************************************************
**                                                                            **
**  FILENAME    : Dcm_OBD0x07.c                                               **
**                                                                            **
**  Created on  :                                                             **
**  Author      : tao.yu                                                      **
**  Vendor      :                                                             **
**  DESCRIPTION : DCM OBD0x07 API definitions                                 **
**                                                                            **
...
FUNC(Std_ReturnType, DCM_CODE)Dcm_OBD0x07(
        ...
        )
{
    ...
    if (Dcm_MsgCtrl[MsgCtrlId].MsgContext.ReqDataLen != DCM_UDS0X07_REQ_DATA_LENGTH)
    {
        ret = E_NOT_OK;
    }
    else
    {
        DemRet = Dem_DcmSetDTCFilter(DEM_UDS_STATUS_PDTC,
