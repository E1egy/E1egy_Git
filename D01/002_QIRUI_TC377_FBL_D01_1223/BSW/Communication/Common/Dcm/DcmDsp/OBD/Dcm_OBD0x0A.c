...
FUNC(Std_ReturnType, DCM_CODE)Dcm_OBD0x0A(
        ...
        )
{
    ...
    {
        DemRet = Dem_DcmSetDTCFilter(0xFF,
            DEM_DTC_KIND_EMISSION_REL_DTCS,DEM_DTC_FORMAT_OBD,DEM_DTC_ORIGIN_PERMANENT_MEMORY,
