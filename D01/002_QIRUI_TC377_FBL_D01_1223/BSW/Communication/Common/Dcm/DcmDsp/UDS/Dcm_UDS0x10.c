     ...
     else if (ret == E_OK)
     {
         if ((Dcm_DslCfg.pDcmDslProtocol->pDcmDslProtocolRow[ProtocolCtrlId].
              ...
              ((Dcm_DspCfg.pDcm_DspSession->pDcmDspSessionRow[iloop].
               DcmDspSessionForBoot == DCM_SYS_BOOT) || ((Dcm_MsgCtrl[MsgCtrlId].
               MsgContext.MsgAddInfo.SuppressPosResponse == TRUE) && (Dcm_DspCfg.
               pDcm_DspSession->pDcmDspSessionRow[iloop].DcmDspSessionForBoot ==
