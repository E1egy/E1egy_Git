...
#define DCM_START_SEC_CODE
#include "Dcm_MemMap.h"
static Std_ReturnType  DspInternalUDS0x2C_SourceDidCheck(uint16 RecDid,
        P2VAR(uint8, AUTOMATIC, AUTOMATIC)pDidCfgIndex)
{
    uint8     Index;
    Std_ReturnType  ret = E_NOT_OK;
...
#define DCM_START_SEC_CODE
#include "Dcm_MemMap.h"
static Std_ReturnType  DspInternalUDS0x2C_SourceDidLength(uint8 DidCfgIndex,
        ...
        P2VAR(Dcm_NegativeResponseCodeType,AUTOMATIC,DCM_VAR) ErrorCode)
{
    ...
    if ((E_OK == ret) && (Dcm_MsgCtrl[Dcm_ProtocolCtrl[ProtocolCtrlId].MsgCtrlIndex].
            MsgContext.ReqDataLen < DCM_UDS0X2C_REQ_DATA_MINLENGTH))
    {
    ...
    if (E_OK == ret)
    {
        ...
        {
            /*check the massage length*/
            if ((Dcm_MsgCtrl[Dcm_ProtocolCtrl[ProtocolCtrlId].MsgCtrlIndex].
                    MsgContext.ReqDataLen < DCM_UDS0X2C_SUBFUNC0X01_REQ_DATA_MINLENGTH) || ((Dcm_MsgCtrl[MsgCtrlId].MsgContext.ReqDataLen % 4u) != 0u))
            {
                /*the length of massage is not correct,send NRC 0x13*/
                *ErrorCode = DCM_E_INCORRECTMESSAGELENGTHORINVALIDFORMAT;
                ret = E_NOT_OK;
        ...
        {
            if (Dcm_MsgCtrl[Dcm_ProtocolCtrl[ProtocolCtrlId].MsgCtrlIndex].
                    MsgContext.ReqDataLen < DCM_UDS0X2C_SUBFUNC0X02_REQ_DATA_MINLENGTH)
            {
                /*the length of massage is not correct,send NRC 0x13*/
                *ErrorCode = DCM_E_INCORRECTMESSAGELENGTHORINVALIDFORMAT;
                ret = E_NOT_OK;
            ...
            else
            {
                ...
                else
                {
                    ...
                    /*check the massage length*/
                    if ((addressAndLengthFormatIdentifier == 0u) || (((Dcm_MsgCtrl[MsgCtrlId].MsgContext.ReqDataLen - 5UL)
...
#define DCM_START_SEC_CODE
#include "Dcm_MemMap.h"
static FUNC(Std_ReturnType, DCM_CODE)Dcm_UDS0x2CSubDeal_NoFind(uint8 ProtocolCtrlId,
        uint8 DidCfgIndex,
        P2VAR(Dcm_NegativeResponseCodeType,AUTOMATIC,DCM_VAR) ErrorCode)
{
    Std_ReturnType ret = E_OK;
    ...
    uint16 RecDid = (uint16)((uint16)((uint16)Dcm_MsgCtrl[MsgCtrlId].MsgContext.pReqData[2])
            << 8u) |((uint16) Dcm_MsgCtrl[MsgCtrlId].MsgContext.pReqData[3]);
    ...
    if (Find == TRUE)
    {
        ...
        if (Subfunction == DCM_UDS0X2C_01_DDBYDID)
        {
            ...
            if((Dcm_DDDid[iloop].DDDIDNumOfElements + RequestNum) > Dcm_DspCfg.
                pDcmDspDidInfo[Dcm_DspCfg.pDcmDspDid[DidCfgIndex].DcmDspDidInfoIndex].DcmDspDDDIDMaxElements)
            {
            ...
            else
            {
                ...
                {
                    Dcm_DDDid[iloop].DcmDspAlternativeArgumentData[Dcm_DDDid[iloop].
                            DDDIDNumOfElements]. Subfunction = Subfunction;
                    RecDid = (uint16)((uint16)((uint16)Dcm_MsgCtrl[MsgCtrlId].MsgContext.pReqData[4u + (Cnt * (4u))])
                            << 8u) |((uint16) Dcm_MsgCtrl[MsgCtrlId].MsgContext.pReqData[5u + (Cnt * (4u))]);
                    ...
                    if ((ret == E_NOT_OK) || (Length < (uint16)((uint16)Dcm_MsgCtrl[MsgCtrlId].MsgContext.pReqData[6u + (Cnt * (4u))]
                    ...
                    {
                        MemoryAddress = (uint32)(((uint32)Dcm_MsgCtrl[MsgCtrlId].MsgContext.
                            pReqData[4u + (Cnt * (4u))]) << 8u);
                        MemoryAddress = MemoryAddress |
                            (uint32)(((uint32)Dcm_MsgCtrl[MsgCtrlId].MsgContext.
                            pReqData[5u + (Cnt * (4u))]));
                        MemoryAddress = MemoryAddress |
                            (uint32)(((uint32)Dcm_MsgCtrl[MsgCtrlId].MsgContext.
                            pReqData[6u + (Cnt * (4u))] - 1u) << 16u);
                        Dcm_DDDid[iloop].DcmDspAlternativeArgumentData[Dcm_DDDid[iloop].
                              DDDIDNumOfElements].Data = MemoryAddress;
                        Dcm_DDDid[iloop].DcmDspAlternativeArgumentData[Dcm_DDDid[iloop].
                              DDDIDNumOfElements].Size = (uint16)Dcm_MsgCtrl[MsgCtrlId].
                                      MsgContext.pReqData[7u + (Cnt * (4u))];
                        TotalSize += Dcm_DDDid[iloop].DcmDspAlternativeArgumentData[Dcm_DDDid[iloop].DDDIDNumOfElements].Size;
                        if (((TotalSize > 7u) && (Dcm_MsgCtrl[MsgCtrlId].MsgContext.pReqData[2] == 0xF2u))
                                || (Dcm_DDDid[iloop].DcmDspAlternativeArgumentData[Dcm_DDDid[iloop].DDDIDNumOfElements].Size == 0u))
                        {
                ...
                for(Cnt = 0u;(Cnt < RequestNum) && (ret == E_OK);Cnt++)
                {
                    ...
                    for(index = 0u;index < memoryAddressByteLength;index++)
                    {
                        ...
                        MemoryAddress = MemoryAddress |
                             ((uint32)Dcm_MsgCtrl[MsgCtrlId].MsgContext.
                              pReqData[5u + index + (Cnt * (memorySizeByteLength +
                    ...
                    for(index = 0u;index < memorySizeByteLength;index++)
                    {
                        ...
                        Memorysize = Memorysize | ((uint32)Dcm_MsgCtrl[MsgCtrlId].
                         MsgContext.pReqData[5u + memoryAddressByteLength + index +
                        (Cnt * (memorySizeByteLength + memoryAddressByteLength))]);
                    }
                    Dcm_DDDid[iloop].DcmDspAlternativeArgumentData[Dcm_DDDid[iloop].
                       DDDIDNumOfElements].Data = MemoryAddress;
                    Dcm_DDDid[iloop].DcmDspAlternativeArgumentData[Dcm_DDDid[iloop].
                        DDDIDNumOfElements].Size = (uint16)Memorysize;
...
#define DCM_START_SEC_CODE
#include "Dcm_MemMap.h"
static FUNC(Std_ReturnType, DCM_CODE)Dcm_UDS0x2CSubDeal(uint8 ProtocolCtrlId,
        uint8 DidCfgIndex,
        P2VAR(Dcm_NegativeResponseCodeType,AUTOMATIC,DCM_VAR) ErrorCode)
{
    Std_ReturnType ret = E_OK;
    ...
    {
        RecDid = (uint16)((uint16)((uint16)Dcm_MsgCtrl[MsgCtrlId].MsgContext.pReqData[2])
        << 8u) |((uint16) Dcm_MsgCtrl[MsgCtrlId].MsgContext.pReqData[3]);
                    ...
                    for(Cnt = 0u;(Cnt < RequestNum) && (ret == E_OK);Cnt++)
                    {
                        ...
                        else
                        {
                            ...
                            Dcm_DDDid[iloop].DcmDspAlternativeArgumentData[Dcm_DDDid[iloop].
                                DDDIDNumOfElements].Data = MemoryAddress;
                            Dcm_DDDid[iloop].DcmDspAlternativeArgumentData[Dcm_DDDid[iloop].
                                DDDIDNumOfElements].Size =
                                (uint16)((uint16)Dcm_MsgCtrl[MsgCtrlId].
                                MsgContext.pReqData[7u + (Cnt * (4u))]);
                            TotalSize += Dcm_DDDid[iloop].DcmDspAlternativeArgumentData[Dcm_DDDid[iloop].DDDIDNumOfElements].Size;
                            if (((TotalSize > 7u) && (Dcm_MsgCtrl[MsgCtrlId].MsgContext.pReqData[2] == 0xF2u))
                                || (Dcm_DDDid[iloop].DcmDspAlternativeArgumentData[Dcm_DDDid[iloop].DDDIDNumOfElements].Size == 0u))
                    ...
                    for(Cnt = 0u;(Cnt < RequestNum) && (ret == E_OK);Cnt++)
                    {
                        ...
                        for(index = 0u;index < memorySizeByteLength;index++)
                        {
                            ...
                            Memorysize = Memorysize |
                               (uint32)(((uint32)Dcm_MsgCtrl[MsgCtrlId].MsgContext.
                               pReqData[5u + memoryAddressByteLength + index + (Cnt *
                               (memorySizeByteLength + memoryAddressByteLength))]));
                        }
                        Dcm_DDDid[iloop].DcmDspAlternativeArgumentData[Dcm_DDDid[iloop].
                           DDDIDNumOfElements].Data = MemoryAddress;
