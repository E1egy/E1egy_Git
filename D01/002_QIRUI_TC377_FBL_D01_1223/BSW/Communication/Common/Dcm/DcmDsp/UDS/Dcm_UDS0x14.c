        ...
        P2VAR(Dcm_NegativeResponseCodeType,AUTOMATIC,DCM_VAR) ErrorCode)
{
    ...
    if((E_OK == ret) &&
            (DCM_UDS0X14_REQ_DATA_LENGTH != Dcm_MsgCtrl[MsgCtrlId].MsgContext.ReqDataLen))
    {
    ...
    if(E_OK == ret)
    {
        ...
        returnClearDTC = Dem_DcmCheckClearParameter(groupOfDTC,DEM_DTC_FORMAT_UDS,
