        ...
        P2VAR(Dcm_NegativeResponseCodeType,AUTOMATIC,DCM_VAR) ErrorCode)
{
    ...
    if (E_OK == ret)
    {
        ...
        transferRequestParameterRecordSize =
                Dcm_MsgCtrl[MsgCtrlId].MsgContext.ReqDataLen - 1u;
        ...
        ret = Dcm_ProcessRequestTransferExit(OpStatus,transferRequestParameterRecord,
                transferRequestParameterRecordSize,transferResParameterRecord,
                &transferResponseParameterRecordSize,ErrorCode);
    ...
    if ((E_OK == ret) && ((1u + transferResponseParameterRecordSize) >
    ...
    if (E_OK == ret)
    {
        ...
        Dcm_UDS_UDS0x31_37Flag = performed;
    }
    return ret;
}
#define DCM_STOP_SEC_CODE
