        ...
        P2VAR(Dcm_NegativeResponseCodeType,AUTOMATIC,DCM_VAR) ErrorCode)
{
    ...
    if (E_OK == ret)
    {
                ...
                (Dcm_DspProgram.Status == DCM_UDS0X36_TO_DOWNLOAD))
        {
            ...
            //Dcm_DspProgram.address += (Dcm_DspProgram.BlockLength - 2u);
            Dcm_DspProgram.address += (MemorySize - 2u);
        ...
        P2VAR(Dcm_NegativeResponseCodeType,AUTOMATIC,DCM_VAR) ErrorCode)
{
    ...
    if (E_OK == ret)
    {
                ...
                == DCM_UDS0X38_0x01) || (Dcm_DspProgram.Status == DCM_UDS0X38_0x03))
        {
            ...
            ret = Dcm_WriteMemory(OpStatus,MemoryIdentifier,Dcm_DspProgram.address,(MemorySize-2u),
    ...
    {
        if ((0u == tempblockId) &&
            (0xFFu == Dcm_DspProgram.reqBlockId))
        {
            tempblockId = 0xFF;
        }
