    ...
    if (pSecurityRow != NULL_PTR)
    {
        ...
        if (ReqLen != ReqCfgLen)
        {
            ...
            if ((0x01u != (SubFunction & 0x01u))
                    && (SubFunction == (Dcm_SecCtrl.Dcm_SubfunctionForSeed + 1u))
                    && (Dcm_SecCtrl.Dcm_SecServiceState == DCM_SERVICE_SEED))
            {
                     ...
                     || (USE_ASYNCH_CLIENT_SERVER == pSecurityRow->DcmDspSecurityUsePort)))
                {
                    ...
                    {
                        (void)pSecurityRow->Dcm_SetSecurityAttemptCounterFnc(OpStatus,
        ...
        P2VAR(Dcm_NegativeResponseCodeType,AUTOMATIC,DCM_VAR) ErrorCode)
{
    ...
    pSecurityRow = &(Dcm_DspCfg.pDcm_DspSecurity->
            pDcm_DspSecurityRow[Dcm_0x27Type->SecCfgIndex]);
    if (pSecurityRow == NULL_PTR)
    {
        ret = E_NOT_OK;
    }
    ...
    if (E_OK == ret)
    {
        ...
        if(0u == AdrSize)
        {
             ...
             if(DCM_SERVICE_IDLE == Dcm_SecCtrl.Dcm_SecServiceState)
             {
                ret = (*Dcm_0x27Type->GottSeed)(
                                    ...
                                    NULL_PTR,
#endif
                                    OpStatus,&Dcm_Channel[Offset + 2u],ErrorCode);
        ...
        {   /*read-out ADR  from request message*/
            ...
            {
                ret = (*Dcm_0x27Type->GottSeed)(
                        &Dcm_Adr[0],OpStatus,&Dcm_Channel[Offset+2u],ErrorCode);
                if (DCM_E_PENDING == ret)
                {
                     SchM_Enter_Dcm(Dcm_MsgCtrl);
                     Dcm_MsgCtrl[MsgCtrlID].Dcm_OpStatus = DCM_PENDING;
    ...
    if ((E_OK == ret) && (((uint16)0x02u + SeedSize) >
        ...
        P2VAR(Dcm_NegativeResponseCodeType,AUTOMATIC,DCM_VAR) ErrorCode)
{
    ...
    P2CONST(Dcm_DspSecurityRowType,AUTOMATIC,DCM_CONST)pSecurityRow;
    pSecurityRow =
            &(Dcm_DspCfg.pDcm_DspSecurity->pDcm_DspSecurityRow[Dcm_0x27Type->SecCfgIndex]);
    if (pSecurityRow == NULL_PTR)
    {
        ret = E_NOT_OK;
    }
    if ((E_OK == ret) && ((SubFunction <= Dcm_SecCtrl.Dcm_SubfunctionForSeed)
        || (1u != (SubFunction - Dcm_SecCtrl.Dcm_SubfunctionForSeed))))
    {
        ...
        if(Dcm_SecCtrl.Dcm_FalseAcessCount[Dcm_0x27Type->SecCfgIndex] >=
                pSecurityRow->DcmDspSecurityNumAttDelay)
        {
            Dcm_ResetTime(&Dcm_SecCtrl.Dcm_RunDlyCtrl.Dcm_SecCurTimer[Dcm_0x27Type->SecCfgIndex]);
            Dcm_SecCtrl.Dcm_RunDlyCtrl.Dcm_SecExpiredTimer[Dcm_0x27Type->SecCfgIndex] = pSecurityRow->DcmDspSecurityDelayTime;
    ...
    if (E_OK == ret)
    {
        ...
        ret = (*Dcm_0x27Type->ComparedKey)(
                &(Dcm_MsgCtrl[MsgCtrlID].MsgContext.pReqData[2]),OpStatus,ErrorCode);
        if (DCM_E_PENDING == ret)
        {
            SchM_Enter_Dcm(Dcm_MsgCtrl);
            Dcm_MsgCtrl[MsgCtrlID].Dcm_OpStatus = DCM_PENDING;
        ...
        { /*'compare key' is failed,increase the false count*/
            ...
            {
                SchM_Enter_Dcm(Dcm_SecCtrl);
                Dcm_ResetTime(&Dcm_SecCtrl.Dcm_RunDlyCtrl.
                        Dcm_SecCurTimer[Dcm_0x27Type->SecCfgIndex]);
                Dcm_SecCtrl.Dcm_RunDlyCtrl.Dcm_SecExpiredTimer[Dcm_0x27Type->SecCfgIndex] =
                        pSecurityRow->DcmDspSecurityDelayTime;
                Dcm_SecCtrl.Dcm_RunDlyCtrl.Dcm_SecTimerState[Dcm_0x27Type->SecCfgIndex] =
                        DCM_SECTIMER_ON;
                SchM_Exit_Dcm(Dcm_SecCtrl);
                DslInternal_SetSecurityAccessStatus(DCM_SERVICE_IDLE);
    ...
    if ((E_OK == ret)
        && ((2u) > (Dcm_DslCfg.pDcmChannelCfg[TxChannelCfgIndex].Dcm_DslBufferSize)))
    {
        /* check tx data length */
        /*Pdu length is bigger than buffer size,ignore the request message */
        *ErrorCode = DCM_E_RESPONSETOOLONG;
        ...
        P2VAR(Dcm_NegativeResponseCodeType,AUTOMATIC,DCM_VAR) ErrorCode)
{
    ...
    if((E_OK == ret) && ((uint16)Dcm_MsgCtrl[Dcm_ProtocolCtrl[ProtocolCtrlId].MsgCtrlIndex].
            MsgContext.ReqDataLen < DCM_UDS0X27_REQ_DATA_MINLENGTH))
    {
        *ErrorCode = DCM_E_INCORRECTMESSAGELENGTHORINVALIDFORMAT;
        ret = E_NOT_OK;
    }
    ...
    /*check the status*/
    if ((E_OK == ret) && (DCM_SERVICE_SEED != Dcm_SecCtrl.Dcm_SecServiceState)
            && (0x01u != (SubFunction & 0x01u)))
    {
    ...
    if((E_OK == ret) && (DCM_SECTIMER_ON == Dcm_SecCtrl.Dcm_RunDlyCtrl.
     Dcm_SecTimerState[SecCfgIndex]) && (Dcm_SecCtrl.Dcm_FalseAcessCount[SecCfgIndex]>=
...
#if 0
    if((E_OK == ret) && (Dcm_SecCtrl.Dcm_FalseAcessCount[SecCfgIndex] >= Dcm_DspCfg.
       pDcm_DspSecurity->pDcm_DspSecurityRow[SecCfgIndex].DcmDspSecurityNumAttDelay))
    {
        ...
        DslInternal_SetSecurityAccessStatus(DCM_SERVICE_IDLE);
        *ErrorCode = DCM_E_EXCEEDEDNUMBEROFATTEMPTS;
        ret = E_NOT_OK;
    }
#endif
    ...
    if(E_OK == ret)
    {
        if ((USE_ASYNCH_FNC == (Dcm_DspCfg.pDcm_DspSecurity->pDcm_DspSecurityRow)[SecCfgIndex].
            DcmDspSecurityUsePort) || (USE_ASYNCH_CLIENT_SERVER == (Dcm_DspCfg.
            pDcm_DspSecurity->pDcm_DspSecurityRow)[SecCfgIndex].DcmDspSecurityUsePort))
        {
            ComparedKey = (Dcm_DspCfg.pDcm_DspSecurity->pDcm_DspSecurityRow)[SecCfgIndex].
                    Dcm_CompareKeyFnc;
            GottSeed = (Dcm_DspCfg.pDcm_DspSecurity->pDcm_DspSecurityRow)[SecCfgIndex].
                    Dcm_GetSeedFnc;
        }
