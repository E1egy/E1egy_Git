...
#define DCM_DET_REPORTERROR(ApiId,ErrorId)     (\
...
extern VAR(SchedulerQueueTransmitTypes,DCM_VAR_NOINIT)
...
#define  DCM_START_SEC_VAR_POWER_ON_INIT_BOOLEAN
#include "Dcm_MemMap.h"
extern VAR(boolean, DCM_VAR_POWER_ON_INIT) ReProgramingRequest;
#define  DCM_STOP_SEC_VAR_POWER_ON_INIT_BOOLEAN
#include "Dcm_MemMap.h"
