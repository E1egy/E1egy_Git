 ...
 *  V2.0.0       2020-08-11  Wanglili       R19_11 initial version.
 */
#ifndef NM_H_
#define NM_H_
...
#define NM_H_AR_RELEASE_MAJOR_VERSION                        19u
#define NM_H_AR_RELEASE_MINOR_VERSION                        11u
#define NM_H_AR_RELEASE_PATCH_VERSION                        0u
#define NM_H_SW_MAJOR_VERSION                                2u
#define NM_H_SW_MINOR_VERSION                                0u
#define NM_H_SW_PATCH_VERSION                                3u
...
typedef Std_ReturnType (*BusNm_NetworkRequest_Type)(
    NetworkHandleType nmNetworkHandle);
/* <BusNm>_NetworkRelease */
typedef Std_ReturnType (*BusNm_NetworkRelease_Type)(
    NetworkHandleType nmNetworkHandle);
#endif/* STD_OFF ==  NM_PASSIVE_MODE_ENABLED */

/* <BusNm>_PassiveStartUp function */
typedef Std_ReturnType (*BusNm_PassiveStartUp_Type)(
    NetworkHandleType nmNetworkHandle);

#if (STD_ON ==  NM_COM_CONTROL_ENABLED)
/* <BusNm>DisableCommunication */
typedef Std_ReturnType (*BusNm_DisableCommunication_Type)(
    NetworkHandleType nmNetworkHandle);

/* <BusNm>_EnableCommunication */
typedef Std_ReturnType (*BusNm_EnableCommunication_Type)(
    NetworkHandleType nmNetworkHandle);
...
/* <BusNm>_SetUserData */
typedef Std_ReturnType (*BusNm_SetUserData_Type)(
    NetworkHandleType nmNetworkHandle,
...
/* <BusNm>_GetUserData */
typedef Std_ReturnType (*BusNm_GetUserData_Type)(
    NetworkHandleType nmNetworkHandle,
    uint8* nmUserDataPtr);
#endif/* STD_ON == NM_USER_DATA_ENABLED */

#if ((STD_ON == NM_COM_USER_DATA_SUPPORT)||\
(STD_ON ==  NM_NODE_ID_ENABLED))
/* <BusNm>_GetPduData */
typedef Std_ReturnType (*BusNm_GetPduData_Type)(
    NetworkHandleType nmNetworkHandle,
    uint8* nmPduData);
...
typedef Std_ReturnType (*BusNm_RepeatMessageRequest_Type)(
    NetworkHandleType nmNetworkHandle);
#endif/* STD_ON == NM_NODE_DETECTION_ENABLED */

#if (STD_ON == NM_NODE_ID_ENABLED)
/* <BusNm>_GetNodeIdentifier */
typedef Std_ReturnType (*BusNm_GetNodeIdentifier_Type)(
    NetworkHandleType nmNetworkHandle,
    uint8* nmNodeIdPtr);

/* <BusNm>_GetLocalNodeIdentifier */
typedef Std_ReturnType (*BusNm_GetLocalNodeIdentifier_Type)(
    NetworkHandleType nmNetworkHandle,
    uint8* nmNodeIdPtr);
