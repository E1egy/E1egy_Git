...
*******************************************************************************/
#define CANSM_C_AR_RELEASE_MAJOR_VERSION                        19u
#define CANSM_C_AR_RELEASE_MINOR_VERSION                        11u
#define CANSM_C_AR_RELEASE_PATCH_VERSION                        0u
#define CANSM_C_SW_MAJOR_VERSION                                2u
#define CANSM_C_SW_MINOR_VERSION                                0u
#define CANSM_C_SW_PATCH_VERSION                                8u
/*******************************************************************************
**                      Include Section                                       **
*******************************************************************************/
#include "CanSM.h"
...
*******************************************************************************/
  ...
  #error "CanSM.c : Mismatch in Software Major Version"
#endif
#if (CANSM_C_SW_MINOR_VERSION != CANSM_H_SW_MINOR_VERSION)
  #error "CanSM.c : Mismatch in Software MINOR Version"
#endif
/*******************************************************************************
...
#define CANSM_NETWORK_HANDLE(NetworkHandle_Index)       CanSM_ConfigPtr->CanSMManagerNetworkRef[NetworkHandle_Index].CanSMComMNetworkHandleRef

#define CANSM_NETWORK_CONFIGURATION(NetworkHandle_Index)     CanSM_ConfigPtr->CanSMManagerNetworkRef[NetworkHandle_Index]

#define CANSM_NETWORK_CONTROLLER(NetworkHandle_Index)        CanSM_ConfigPtr->CanSMManagerNetworkRef[NetworkHandle_Index].ControllerRef

#define CANSM_NETWORK_TRANSCEIVER(NetworkHandle_Index)       CanSM_ConfigPtr->CanSMManagerNetworkRef[NetworkHandle_Index].TrcvRef

#define CANSM_MODEREQREPEAT_MAINFUNCTIONTIME                 CanSM_ConfigPtr->CanSMModeRequestRepetitionTime/CANSM_MAINFUNCTION_PERIOD

#define CANSM_NETWORK_BORTXENSUREDTIME(NetworkHandle_Index)  \
    CanSM_ConfigPtr->CanSMManagerNetworkRef[NetworkHandle_Index].CanSMBorTimeTxEnsured/CANSM_MAINFUNCTION_PERIOD
...
CanSM_PnNot_CC_Stopped(
    uint8 netID,
    CanSM_NetWorkRunTimeType *networkPtr
);

static FUNC(void, CANSM_CODE)
CanSM_PnNot_CC_Stopped_Wait(
    CanSM_NetWorkRunTimeType *networkPtr
);

static FUNC(void, CANSM_CODE)
CanSM_PnNot_CC_Sleep(
    uint8 netID,
    CanSM_NetWorkRunTimeType *networkPtr
);

static FUNC(void, CANSM_CODE)
CanSM_PnNot_CC_Sleep_Wait(
    uint8 netID,
    CanSM_NetWorkRunTimeType *networkPtr
);
...
#if (CANSM_TRCV_NUM > 0)
static FUNC(void, CANSM_CODE)
CanSM_PnNot_Trcv_Normal(
    uint8 netID,
    CanSM_NetWorkRunTimeType *networkPtr
);

static FUNC(void, CANSM_CODE)
CanSM_PnNot_Trcv_Normal_Wait(
    CanSM_NetWorkRunTimeType *networkPtr
);

static FUNC(void, CANSM_CODE)
CanSM_PnNot_Trcv_Standby(
    uint8 netID,
    CanSM_NetWorkRunTimeType *networkPtr
);

static FUNC(void, CANSM_CODE)
CanSM_PnNot_Trcv_Standby_Wait(
    uint8 netID,
    CanSM_NetWorkRunTimeType *networkPtr
);
#endif
...
static FUNC(void, CANSM_CODE)
CanSM_DeinitPnNotSupported(uint8 netID);

#if(STD_ON == CANSM_PNC_SUPPORT)
static FUNC(void, CANSM_CODE)
CanSM_Pn_S_Pn_Clear_WUF(
    uint8 netID,
    CanSM_NetWorkRunTimeType *networkPtr
);

static FUNC(void, CANSM_CODE)
CanSM_Pn_S_Pn_Clear_WUF_Wait(
    CanSM_NetWorkRunTimeType *networkPtr
);

static FUNC(void, CANSM_CODE)
CanSM_Pn_S_Pn_CC_Stopped(
    uint8 netID,
    CanSM_NetWorkRunTimeType *networkPtr
);

static FUNC(void, CANSM_CODE)
CanSM_Pn_S_Pn_CC_Stopped_Wait(
    CanSM_NetWorkRunTimeType *networkPtr
);

static FUNC(void, CANSM_CODE)
CanSM_Pn_S_Trcv_Normal(
    uint8 netID,
    CanSM_NetWorkRunTimeType *networkPtr
);

static FUNC(void, CANSM_CODE)
CanSM_Pn_S_Trcv_Normal_Wait(
    CanSM_NetWorkRunTimeType *networkPtr
);

static FUNC(void, CANSM_CODE)
CanSM_Pn_S_Trcv_Standby(
    uint8 netID,
    CanSM_NetWorkRunTimeType *networkPtr
);

static FUNC(void, CANSM_CODE)
CanSM_Pn_S_Trcv_Standby_Wait(
    CanSM_NetWorkRunTimeType *networkPtr
);
...
static FUNC(void, CANSM_CODE)
CanSM_Pn_S_CC_Sleep_Wait(
    CanSM_NetWorkRunTimeType *networkPtr
);

static FUNC(void, CANSM_CODE)
CanSM_Pn_Check_Wflag_InCCSleep(
    uint8 netID,
    CanSM_NetWorkRunTimeType *networkPtr
);

static FUNC(void, CANSM_CODE)
CanSM_Pn_Check_Wflag_InCCSleepWait(
    uint8 netID,
    CanSM_NetWorkRunTimeType *networkPtr
);

static FUNC(void, CANSM_CODE)
CanSM_Pn_CheckWflag_InNotCCSleep(
    uint8 netID,
    CanSM_NetWorkRunTimeType *networkPtr
);

static FUNC(void, CANSM_CODE)
CanSM_Pn_CheckWFlag_InNotCCSleepWait(
    CanSM_NetWorkRunTimeType *networkPtr
);

static FUNC(void, CANSM_CODE)
CanSM_DeinitPnSupported(uint8 netID);
#endif

static FUNC(void, CANSM_CODE)
CanSM_BsmSNoCom(uint8 netID);

#if(CANSM_TRCV_NUM > 0)
static FUNC(void, CANSM_CODE)
CanSM_WUVAL_S_Trcv_Normal(
    uint8 netID,
    CanSM_NetWorkRunTimeType *networkPtr
);

static FUNC(void, CANSM_CODE)
CanSM_WUVAL_S_Trcv_Normal_Wait(
    CanSM_NetWorkRunTimeType *networkPtr
);
#endif

static FUNC(void, CANSM_CODE)
CanSM_WUVAL_S_CC_Stopped(
    uint8 netID,
    CanSM_NetWorkRunTimeType *networkPtr
);

static FUNC(void, CANSM_CODE)
CanSM_WUVAL_S_CC_Stopped_Wait(
    CanSM_NetWorkRunTimeType *networkPtr
);

static FUNC(void, CANSM_CODE)
CanSM_WUVAL_S_CC_Started(
    uint8 netID,
    CanSM_NetWorkRunTimeType *networkPtr
);

static FUNC(void, CANSM_CODE)
CanSM_WUVAL_S_CC_Started_Wait(
    CanSM_NetWorkRunTimeType *networkPtr
);

static FUNC(void, CANSM_CODE)
CanSM_BsmWuValidation(uint8 netID);

#if(CANSM_TRCV_NUM > 0)
static FUNC(void, CANSM_CODE)
CanSM_Prefullcom_S_Trcv_Normal(
    uint8 netID,
    CanSM_NetWorkRunTimeType *networkPtr
);

static FUNC(void, CANSM_CODE)
CanSM_Prefullcom_S_Trcv_Normal_Wait(
    CanSM_NetWorkRunTimeType *networkPtr
);
#endif
static FUNC(void, CANSM_CODE)
CanSM_Prefullcom_S_CC_Stopped(
    uint8 netID,
    CanSM_NetWorkRunTimeType *networkPtr
);

static FUNC(void, CANSM_CODE)
CanSM_Prefullcom_S_CC_Stopped_Wait(
    CanSM_NetWorkRunTimeType *networkPtr
);

static FUNC(void, CANSM_CODE)
CanSM_Prefullcom_S_CC_Started(
    uint8 netID,
    CanSM_NetWorkRunTimeType *networkPtr
);

static FUNC(void, CANSM_CODE)
CanSM_Prefullcom_S_CC_Started_Wait(
    uint8 netID,
    CanSM_NetWorkRunTimeType *networkPtr
);

static FUNC(void, CANSM_CODE)
CanSM_BsmSPreFullCom(uint8 netID);

static FUNC(void, CANSM_CODE)
CanSM_FullCom_S_Bus_off_Check(
    uint8 netID,
    CanSM_NetWorkRunTimeType* networkPtr
);

static FUNC(void, CANSM_CODE)
CanSM_FullCom_S_CC_Stopped(
    uint8 netID,
    CanSM_NetWorkRunTimeType* networkPtr
);

static FUNC(void, CANSM_CODE)
CanSM_FullCom_S_CC_Stopped_Wait(
    CanSM_NetWorkRunTimeType* networkPtr
);

static FUNC(void, CANSM_CODE)
CanSM_FullCom_S_CC_Started(
    uint8 netID,
    CanSM_NetWorkRunTimeType* networkPtr
);

static FUNC(void, CANSM_CODE)
CanSM_FullCom_S_CC_Started_Wait(
    uint8 netID,
    CanSM_NetWorkRunTimeType* networkPtr
);

static FUNC(void, CANSM_CODE)
CanSM_FullCom_S_Restart_CC(
    uint8 netID,
    CanSM_NetWorkRunTimeType* networkPtr
);

static FUNC(void, CANSM_CODE)
CanSM_FullCom_S_Restart_CC_Wait(
    CanSM_NetWorkRunTimeType* networkPtr
);

static FUNC(void, CANSM_CODE)
CanSM_FullCom_S_Tx_Off(
    uint8 netID,
    CanSM_NetWorkRunTimeType* networkPtr
);

static FUNC(void, CANSM_CODE)
CanSM_BsmSFullCom(uint8 netID);

#if(STD_ON == CANSM_SET_BAUDRATE_API)
static FUNC(void, CANSM_CODE)
CanSM_ChangeBR_Change_BR_Sync(
    uint8 netID,
    CanSM_NetWorkRunTimeType *networkPtr
);

static FUNC(void, CANSM_CODE)
CanSM_ChangeBR_S_CC_Stopped(
    uint8 netID,
    CanSM_NetWorkRunTimeType *networkPtr
);

static FUNC(void, CANSM_CODE)
CanSM_ChangeBR_S_CC_Stopped_Wait(
    uint8 netID,
    CanSM_NetWorkRunTimeType *networkPtr
);

static FUNC(void, CANSM_CODE)
CanSM_ChangeBR_S_CC_Started(
    uint8 netID,
    CanSM_NetWorkRunTimeType *networkPtr
);

static FUNC(void, CANSM_CODE)
CanSM_ChangeBR_S_CC_Started_Wait(
    uint8 netID,
    CanSM_NetWorkRunTimeType *networkPtr
);

static FUNC(void, CANSM_CODE)
CanSM_BsmSChangeBaudrate(uint8 netID);
#endif

static FUNC(void, CANSM_CODE)
CanSM_BsmSSilentCom(uint8 netID);

static FUNC(void, CANSM_CODE)
CanSM_BsmSSilentComBor(uint8 netID);

static FUNC(void, CANSM_CODE)
CanSM_EFullComAction(uint8 netID);

static FUNC(void, CANSM_CODE)
CanSM_EFullToSilentComAction(uint8 netID);

static FUNC(void, CANSM_CODE)
CanSM_EPreNoComAction(uint8 netID);

static FUNC(Std_ReturnType, CANSM_CODE)
CanSM_SetControllerModeRepeat(uint8 netID,CanSM_NetWorkRunTimeType*networkPtr,CanIf_ControllerModeType requestContorllerMode);
...
#include "CANSM_MemMap.h"
static VAR(CanSM_StateType, CANSM_VAR_POWER_ON_INIT)
CanSM_Status = CANSM_UNINITED;
static P2CONST(CanSM_ConfigType, AUTOMATIC, CANSM_CONFIG_DATA)
CanSM_ConfigPtr = NULL_PTR;
static VAR(CanSM_NetWorkRunTimeType, CANSM_VAR)
CanSM_NetWorkRunTime[CANSM_NETWORK_NUM];
static VAR(CanIf_ControllerModeType, CANSM_VAR)
CanSM_ControllerMode[CANIF_CANCONTROLLER_NUMBER];
...
CanSM_Init(
    P2CONST(CanSM_ConfigType, AUTOMATIC, CANSM_CONFIG_DATA) ConfigPtr
)
{
    uint8 netLoop;
    uint8 controller;
...
{
    uint8 netLoop;
    P2VAR(CanSM_NetWorkRunTimeType, AUTOMATIC, CANSM_VAR)networkPtr = NULL_PTR;
...
)
{
    ...
    #endif
    {
        ...
        if((uint8)E_OK == ret)
        {
            ...
            {
                ret = CanIf_SetIcomConfiguration(CANSM_NETWORK_CONTROLLER(netID)->CanSMControllerId[cnt],ConfigurationId);
            }
        }
        #if(STD_ON == CANSM_DEV_ERROR_DETECT)
        else
    ...
    #endif
    {
        if(((boolean)TRUE == CanSM_Passive) && ((boolean)FALSE == CanSM_EcuPassive))
        {
            ...
            for (netLoop = 0u; netLoop < CANSM_NETWORK_NUM; netLoop++)
            {
                ...
                {
                    (void)CanIf_GetPduMode(CANSM_NETWORK_CONTROLLER(netLoop)->CanSMControllerId[cnt],&controllerPduMode);
                    if(CANIF_ONLINE == controllerPduMode)
                    {
                        (void)CanIf_SetPduMode(CANSM_NETWORK_CONTROLLER(netLoop)->CanSMControllerId[cnt],CANIF_TX_OFFLINE_ACTIVE);
                    }
                }
            }
        }
        else if(((boolean)FALSE == CanSM_Passive) && ((boolean)TRUE == CanSM_EcuPassive))
        {
            ...
            for (netLoop = 0u; netLoop < CANSM_NETWORK_NUM; netLoop++)
            {
                ...
                for(cnt = 0u;cnt < netWorkRefControllerNum;cnt++)
                {
                    ...
                    {
                        (void)CanIf_SetPduMode(CANSM_NETWORK_CONFIGURATION(netLoop).ControllerRef->CanSMControllerId[cnt],CANIF_ONLINE);
                    }
                }
            }
        }
...
)
{
    ...
    if(CANSM_UNINITED == CanSM_Status)
    {
        CANSM_DET_REPORT(SERVICE_ID_CANSM_MAINFUNCTION, CANSM_E_UNINIT);
        detNoErr = FALSE;
    }
    if((boolean)TRUE == detNoErr)
    #endif
...
)
{
    ...
    #endif
    {
        ...
        if((uint8)E_OK == ret)
        {
            if(CANSM_NO_REQUEST == networkPtr->requestComMode)
            {
                switch(ComM_Mode)
                {
...
#endif
                            || (CANSM_BSM_S_SILENTCOM == networkPtr->curBsmState) || (CANSM_BSM_S_SILENTCOM_BOR == networkPtr->curBsmState))
                        {
                    ...
                    case COMM_FULL_COMMUNICATION:
                        if((CANSM_BSM_S_NOCOM == networkPtr->curBsmState) ||
            ...
            else
            {
                ret = E_NOT_OK;
                #if(STD_ON == CANSM_DEV_ERROR_DETECT)
                CANSM_DET_REPORT(SERVICE_ID_CANSM_REQUESTCOMMODE, CANSM_E_WAIT_MODE_INDICATION);
                #endif
            }
        }
        #if(STD_ON == CANSM_DEV_ERROR_DETECT)
...
)
{
    ...
    #endif
    {
        for (cnt = 0u; (cnt < CANSM_NETWORK_NUM) && ((uint8)E_NOT_OK == ret); cnt++)
        {
            if(network == CANSM_NETWORK_HANDLE(cnt))
            {
                *ComM_ModePtr = CanSM_NetWorkRunTime[cnt].curComMode;
                ret = E_OK;
            }
        }
        #if(STD_ON == CANSM_DEV_ERROR_DETECT)
...
)
{
    ...
    #endif
    {
        ...
        {
            if((CANSM_BSM_S_FULLCOM == networkPtr->curBsmState)
                &&((FULLCOM_S_BUS_OFF_CHECK == networkPtr->fullComState) || (FULLCOM_S_NO_BUS_OFF == networkPtr->fullComState)))
            {
                ...
                if(NULL_PTR != CANSM_NETWORK_CONFIGURATION(netID).CanSMDemEventParameterRefs)
                {
                    ...
                    {
                        Dem_ReportErrorStatus(*CANSM_NETWORK_CONFIGURATION(netID).CanSMDemEventParameterRefs->BusOffPara,DEM_EVENT_STATUS_PREFAILED);
                    }
                }
...
)
{
    ...
    #endif
    {
        ...
        {
            CANSM_DET_REPORT(
                    SERVICE_ID_CANSM_CURRENTICOMCONFIGURATION,
...
{
    P2VAR(CanSM_NetWorkRunTimeType, AUTOMATIC, CANSM_VAR)networkPtr = NULL_PTR;
    networkPtr = &CanSM_NetWorkRunTime[netID];  
...
)
{
    ...
    if((0u == networkPtr->ModeRequestRepetitionTime) &&
       (networkPtr->repeatCounter <=  CanSM_ConfigPtr->CanSMModeRequestRepetitionMax))
    {
        ret = CanIf_SetTrcvMode(CANSM_NETWORK_TRANSCEIVER(netID)->CanSMTransceiverId,
...
)
{
    ...
    if((boolean)FALSE == CANSM_NETWORK_CONFIGURATION(netID).CanSMBorTxConfirmationPolling)
    {
        ...
        /*the time duration since the effect E_TX_ON is greater or equal the configuration parameter CANSM_BOR_TIME_TX_ENSURED*/
...
)
{
    ...
    {
        busOffContinueTime =
                (uint32)(CANSM_NETWORK_CONFIGURATION(netID).CanSMBorTimeL2/CANSM_MAINFUNCTION_PERIOD
                #if(STD_ON == CANSM_GET_BUSOFF_DELAY_FUNCTION_USED)
                + networkPtr->busOffDelayTime
                #endif
                );
    }
    else
    {
        busOffContinueTime =
                (uint32)(CANSM_NETWORK_CONFIGURATION(netID).CanSMBorTimeL1/CANSM_MAINFUNCTION_PERIOD
                #if(STD_ON == CANSM_GET_BUSOFF_DELAY_FUNCTION_USED)
                + networkPtr->busOffDelayTime
                #endif
                );
...
)
{
    ...
    ret = E_OK;
    for(cnt = 0u;
            (cnt < CANSM_NETWORK_CONTROLLER(netID)->NetWorkRefControllerNumber) && ((uint8)E_OK == ret);
                cnt++)
    {
        controllerID = CANSM_NETWORK_CONTROLLER(netID)->CanSMControllerId[cnt];
...
)
{
    ...
    /*clear the request Com Mode*/
    networkPtr->requestComMode = CANSM_NO_REQUEST;
}
...
)
{
    ...
    if((CANIF_CS_UNINIT != requestContorllerMode) &&
       (0u == networkPtr->ModeRequestRepetitionTime) &&
       (networkPtr->repeatCounter <=  CanSM_ConfigPtr->CanSMModeRequestRepetitionMax))
    {
        for(cnt = 0u;cnt < CANSM_NETWORK_CONTROLLER(netID)->NetWorkRefControllerNumber;cnt++)
        {
            ...
            if(requestContorllerMode != CanSM_ControllerMode[controllerID])
            {
                ...
                ret = CanIf_SetControllerMode(controllerID,requestContorllerMode);
                if((uint8)E_NOT_OK == ret)
                {
