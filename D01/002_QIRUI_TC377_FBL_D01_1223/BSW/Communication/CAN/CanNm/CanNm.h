...
#define CANNM_H_AR_RELEASE_MAJOR_VERSION                        19u
#define CANNM_H_AR_RELEASE_MINOR_VERSION                        11u
#define CANNM_H_AR_RELEASE_PATCH_VERSION                        0u
#define CANNM_H_SW_MAJOR_VERSION                                2u
#define CANNM_H_SW_MINOR_VERSION                                0u
#define CANNM_H_SW_PATCH_VERSION                                3u
...
extern uint8 g_CanNmSleepFlag;
extern uint8 g_CanNmDetCounter;
extern uint8 g_CanNmActiveCounter;
extern uint8 g_CanNmUnactiveCounter;
/*******************************************************************************
**                      Global Functions                                      **
*******************************************************************************/
