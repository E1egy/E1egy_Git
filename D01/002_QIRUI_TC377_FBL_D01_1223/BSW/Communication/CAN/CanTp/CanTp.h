...
#define CANTP_START_SEC_CODE
#include "CanTp_MemMap.h"
extern FUNC(Std_ReturnType, CANTP_APPL_CODE) CanTp_Transmit(
    PduIdType TxPduId,
...
#define CANTP_START_SEC_CODE
#include "CanTp_MemMap.h"
extern FUNC(Std_ReturnType, CANTP_APPL_CODE) CanTp_ChangeParameter(
    PduIdType id,
...
#define CANTP_START_SEC_CODE
#include "CanTp_MemMap.h"
extern FUNC(Std_ReturnType, CANTP_APPL_CODE) CanTp_ReadParameter(
    PduIdType id,
    TPParameterType parameter,
    uint16* value
);
