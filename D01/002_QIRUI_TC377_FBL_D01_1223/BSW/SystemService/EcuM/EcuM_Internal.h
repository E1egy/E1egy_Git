...
#include "Tm.h"
#else /*(ECUM_USE_TIMER == ECUM_TIMER_USE_OS)*/
...
typedef struct
{
    ...
    P2CONST(NetworkHandleType, TYPEDEF, ECUM_CONST) comMChnl; /*reference to a Network in COMM, INVALID value
...
extern CONST(EcuM_SleepModeCfgType, ECUM_CONST) \
...
extern CONST(EcuM_WakeupSourceCfgType, ECUM_CONST) \
...
extern CONST(EcuM_AlarmClockCfgType, ECUM_CONST) \
EcuM_AlarmClkCfgs[ECUM_MAX_ALARM_CLOCK_NUM];
#define ECUM_STOP_SEC_CONFIG_DATA_UNSPECIFIED
#include "EcuM_MemMap.h"
#endif /*(ECUM_ALARM_CLOCK_PRESENT == STD_ON)*/
...
#include "EcuM_MemMap.h"
extern volatile VAR(boolean, ECUM_CLEARED)
EcuM_ShutdownFlag;
