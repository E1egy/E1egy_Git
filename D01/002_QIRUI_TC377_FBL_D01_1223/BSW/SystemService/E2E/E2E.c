...
#if ( E2E_AR_RELEASE_MAJOR_VERSION != 19U )
  #error "E2E_AR_RELEASE_MAJOR_VERSION does not match. "
#endif
#if ( E2E_AR_RELEASE_MINOR_VERSION != 11U )
...
static FUNC(void, E2E_CODE) E2E_SMAddStatus(E2E_PCheckStatusType ProfileStatus,P2CONST(E2E_SMConfigType, AUTOMATIC, E2E_APPL_DATA) Config,P2VAR(E2E_SMCheckStateType, AUTOMATIC, E2E_APPL_DATA) State);
#define E2E_STOP_SEC_CODE
#include "E2E_MemMap.h"

#define E2E_START_SEC_CODE
#include "E2E_MemMap.h"
static FUNC(void, E2E_CODE) E2E_SMClearStatus(P2VAR(E2E_SMCheckStateType, AUTOMATIC, E2E_APPL_DATA) State,P2CONST(E2E_SMConfigType, AUTOMATIC, E2E_APPL_DATA) Config);
#define E2E_STOP_SEC_CODE
#include "E2E_MemMap.h"

#define E2E_START_SEC_CODE
#include "E2E_MemMap.h"
static FUNC(void, E2E_CODE) E2E_SMClearRemainingStatus(P2VAR(E2E_SMCheckStateType, AUTOMATIC, E2E_APPL_DATA) State,P2CONST(E2E_SMConfigType, AUTOMATIC, E2E_APPL_DATA) Config,VAR(E2E_SMStateType,E2E_APPL_DATA) NextState);
#define E2E_STOP_SEC_CODE
#include "E2E_MemMap.h"
/*******************************************************************************
...
#define E2E_START_SEC_CODE
#include "E2E_MemMap.h"
FUNC(Std_ReturnType, E2E_CODE) E2E_SMCheck( E2E_PCheckStatusType ProfileStatus,P2CONST(E2E_SMConfigType, AUTOMATIC, E2E_APPL_DATA) ConfigPtr,P2VAR(E2E_SMCheckStateType, AUTOMATIC, E2E_APPL_DATA) StatePtr )
{
    Std_ReturnType Ret;
    Ret = E2E_E_OK;
...
#define E2E_START_SEC_CODE
#include "E2E_MemMap.h"
FUNC(Std_ReturnType, E2E_CODE) E2E_SMCheckInit( P2VAR(E2E_SMCheckStateType, AUTOMATIC, E2E_APPL_DATA) StatePtr,P2CONST(E2E_SMConfigType, AUTOMATIC, E2E_APPL_DATA) ConfigPtr )
{
    Std_ReturnType Ret;
    uint8 index;
...
static FUNC(void, E2E_CODE) E2E_SMAddStatus(E2E_PCheckStatusType ProfileStatus,P2CONST(E2E_SMConfigType, AUTOMATIC, E2E_APPL_DATA) Config,P2VAR(E2E_SMCheckStateType, AUTOMATIC, E2E_APPL_DATA) State)
{
    ...
    if(State->SMState == E2E_SM_VALID)
    {
        CurrentWindowSize = Config->WindowSizeValid;
    }
    else if(State->SMState == E2E_SM_INIT)
    {
    ...
    for(index=0; index < CurrentWindowSize; index++) 
    {
        if(State->ProfileStatusWindow[index] == (uint8)E2E_P_OK) 
        {
          Count++;
        }
    }
    ...
    for(index=0; index < CurrentWindowSize; index++) 
    {
        if(State->ProfileStatusWindow[index] == (uint8)E2E_P_ERROR) 
        {
          Count++;
        }
    }
...
static FUNC(void, E2E_CODE) E2E_SMClearRemainingStatus(P2VAR(E2E_SMCheckStateType, AUTOMATIC, E2E_APPL_DATA) State,P2CONST(E2E_SMConfigType, AUTOMATIC, E2E_APPL_DATA) Config,VAR(E2E_SMStateType,E2E_APPL_DATA) NextState)
{
    ...
    else if(NextState == E2E_SM_INVALID)
    {
