...
#if ((STD_ON == COMM_0PNC_VECTOR_AVOIDANCE) && (STD_ON == VERSION_R19_11))
FUNC(void, COMM_CODE) ComM_0PncVector_Avoidance(
    NetworkHandleType Channel);
#endif /*end of #if ((STD_ON == COMM_0PNC_VECTOR_AVOIDANCE) && (STD_ON == VERSION_R19_11))*/
...
#include "ComM_MemMap.h"
P2CONST(ComM_ConfigType, AUTOMATIC, COMM_CONST) ComM_ConfigPtr = NULL_PTR;
...
static FUNC(void, COMM_CODE) ComM_EnterPncPrepareSleep(PNCHandleType Pnc, NetworkHandleType Channel)
{
    ...
    COMM_PNC_EVENT_CLR(Pnc, COMM_EVENT_ECUM_WAKEUP
            ...
            #endif /*end of #if (STD_ON == VERSION_R19_11)*/
                );
    #endif
