...
**                       Version  information                                 **
*******************************************************************************/
#define DEM_TYPES_H_AR_MAJOR_VERSION        4U
#define DEM_TYPES_H_AR_MINOR_VERSION        2U
#define DEM_TYPES_H_AR_PATCH_VERSION        2U
#define DEM_TYPES_H_SW_MAJOR_VERSION        2U
#define DEM_TYPES_H_SW_MINOR_VERSION        0U
#define DEM_TYPES_H_SW_PATCH_VERSION        1U
...
typedef uint16 Dem_EventIdType;/*Internal identifier of a diagnostic event Remark: 0 is not a valid value*/

typedef uint16 Dem_RatioIdType;/*OBD specific ratio Id (related to a specific event, a FID, and an IUMPR group). This type depends on the Dem configuration.*/
...
typedef struct
{
    ...
    uint16 TimeSinceDiagnosticTroubleCodesCleared; /*Engine running time accumulated since emission related DTCs were cleared*/
}Dem_J1939DcmDiagnosticReadiness2Type; /*This structure represents all data elemets of the DM21 message*/
...
typedef struct
{
    ...
    uint16 NonContinuouslyMonitoredSystemsEnableStatus; /*Enable status of noncontinuous monitors this monitoring cycle*/
    uint16 NonContinuouslyMonitoredSystems; /*Completion status of noncontinuous monitors this monitoring cycle*/
}Dem_J1939DcmDiagnosticReadiness3Type; /*This structure represents all data elemets of the DM26 message*/

/*******************************************************************************
**                      Dem return types                                      **
*******************************************************************************/
typedef uint8 Dem_ReturnCheckEntryIsStoredType;
#define DEM_CHECK_STORED_OK                         0x00u
#define DEM_CHECK_STORED_NOT_OK                     0x01u
...
#define DEM_STATUS_PENDING                          0x04u /*The requested value is calculated asynchronously and currently not available. The caller can retry later*/
...
#define DEM_GET_SEVERITYOFDTC_PENDING               0x03u /*The requested value is calculated asynchronously and currently not available. The caller can retry later.*/
...
#define DEM_NUMBER_PENDING                          0x02u /*The requested value is calculated asynchronously and currently not available. The caller can retry later*/

typedef uint8 Dem_ReturnGetNextFilteredElementType; /*Used to return the status of Dem_DcmGetNextFilteredXxx and Dem_J1939DcmGetNextFilteredXxx.*/
...
#define DEM_FILTERED_PENDING                        0x02u /*The requested value is calculated asynchronously and currently not available. The caller can retry later.
...
#define DEM_GET_FFDATABYDTC_WRONG_RECORDNUMBER      0x03u /*Record number is not supported by configuration and therefore invalid*/
#define DEM_GET_FFDATABYDTC_WRONG_BUFFERSIZE        0x04u /*provided buffer size to small*/
#define DEM_GET_FFDATABYDTC_PENDING                 0x05u /*The requested value is calculated asynchronously and currently not available. The caller can retry later.*/
#define DEM_GET_FFDATABYDTC_FAILED                  0x06u /*failed to get ,because there is no event failed */

typedef uint8 Dem_ReturnGetExtendedDataRecordByDTCType; /*Used to return the status of Dem_DcmGetExtendedDataRecordByDTC*/
...
#define DEM_RECORD_PENDING                          0x05u /*The requested value is calculated asynchronously and currently not available. The caller can retry later.*/
#define DEM_RECORD_FAILED                           0x06u /*failed to get ,because there is no event failed */

typedef uint8 Dem_ReturnGetSizeOfDataByDTCType; /*Used to return the status of Dem_DcmGetSizeOfFreezeFrameByDTC and Dem_DcmGetSizeOfExtendedDataRecordByDTC.*/
...
#define DEM_GETSIZEBYDTC_PENDING                    0x04u /*The requested value is calculated asynchronously and currently not available. The caller can retry later*/
...
#define DEM_CLEAR_PENDING                           0x04u /*The DTC clearing is performed asynchronously and still pending. The caller can retry later*/
#define DEM_CLEAR_BUSY                              0x05u /*DTC not cleared, as another clearing process is in progress. The caller can retry later*/
#define DEM_CLEAR_MEMORY_ERROR                      0x06u /*An error occurred during erasing a memory location (e.g. if DemClearDTCBehavior in Dem is
...
typedef uint8 Dem_ReturnControlDTCSettingType; /*Used to return the status of Dem_DcmDisableDTCSetting and Dem_DcmEnableDTCSetting*/
...
#define DEM_SID_DCMGETNEXTFILTEREDDTCANDSEVERITY        0x3du
