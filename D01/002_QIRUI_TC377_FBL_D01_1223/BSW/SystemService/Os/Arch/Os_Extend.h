 ...
 */
/********************************************************************/
extern FUNC(StatusType, OS_CODE) osGetTaskCpuUsage(Os_TaskType taskId, Os_ExcuteUsageTypeRef usage);
 ...
 */
/********************************************************************/
extern FUNC(StatusType, OS_CODE) osGetIsrCpuUsage(Os_IsrType isrId, Os_ExcuteUsageTypeRef usage);
 ...
 */
/********************************************************************/
extern FUNC(void, OS_CODE) osSetObjectStartPoint(void);
 ...
 */
/********************************************************************/
extern FUNC(void, OS_CODE) osSetObjectStopPoint(void);
