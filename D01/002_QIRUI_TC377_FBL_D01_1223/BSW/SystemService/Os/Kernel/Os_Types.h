...
/* DD_1_0131 */
typedef uint8                Os_StackDataType;
...
/* DD_1_1148 */
typedef P2FUNC(void, OS_APPL_CODE, Os_AppTrustedFunc)(TrustedFunctionIndexType ix,
...
typedef struct
{
    ...
    boolean                   callCoreRequest[OS_AUTOSAR_CORES];
}Os_InterCoreType;
...
typedef   P2FUNC(void, OS_APPL_CODE, Os_IocExeNotifyType)(void);
...
typedef struct
{
    ...
    #if (TRUE == CFG_IOC_INIT_VALUE)
    Os_IocValueType    IocInitValue;   /* init value */
    #endif
}Os_IocDataPrpeType;
...
typedef struct
{
	...
	boolean					isStart;
    Os_TickType             entryTick;
    Os_TickType             totalTick;
    Os_TickType             excuteTick;

    /* Usage rate */
    Os_TickType             usageRateCurrent;
    Os_TickType             usageRateLastValid;
    Os_TickType             usageRateMax;
    Os_TickType             usageRateMin;

    /* Excute time */
    Os_TickType             excuteTimeCurrent;
    Os_TickType             excuteTimeMax;
    Os_TickType             excuteTimeMin;

}Os_TimeUsageType;

typedef struct
{
	uint32                  us_excuteTimeCurrent;
	uint32					us_excuteTimeMax;
	uint32					us_excuteTimeMin;

	uint32             		usageRateCurrent;
	uint32             		usageRateLastValid;
	uint32             		usageRateMax;
	uint32             		usageRateMin;
}Os_ExcuteUsageType;

typedef Os_ExcuteUsageType* Os_ExcuteUsageTypeRef;
