...
#include "Os_MemMap.h"
#endif /*#if (TRUE == CFG_CORE2_AUTOSAROS_ENABLE)*/

#define OS_START_SEC_VAR_CLONE
#include "Os_MemMap.h"
extern VAR(boolean volatile, OS_VAR) 						Os_TrapWait;

extern VAR(uint16, OS_VAR)                                  Os_CfgPriorityMax;
extern P2VAR(Os_PriorityType, AUTOMATIC, OS_VAR)            Os_ReadyMap;
#if ((OS_BCC1 == CFG_CC) || (OS_ECC1 == CFG_CC))
extern P2VAR(Os_TaskType, AUTOMATIC, OS_VAR)                Os_ReadyTable;
#else
extern P2VAR(Os_ReadyQueueType, AUTOMATIC, OS_VAR)          Os_ReadyQueueMark;
...
extern VAR(uint16, OS_VAR)                                  Os_CfgStdResourceMax;
...
extern P2VAR(Os_PriorityType , AUTOMATIC, OS_VAR)           Os_OccupyInterRes;
...
extern VAR(TrustedFunctionIndexType,  OS_VAR)
...
extern P2CONST(uint16*, OS_VAR, OS_CONST)                Os_TaskResourceAccessMask;
extern P2CONST(uint16*, OS_VAR, OS_CONST)                Os_IsrResourceAccessMask;
...
extern FUNC(ProtectionReturnType, OS_CODE) Os_CallProtectionHook 
(
...
extern FUNC(void, OS_CODE) Os_ReadyQueueInsert(Os_TaskType object, Os_CallLevelType level,
...
extern FUNC(Os_TickType, OS_CODE) Os_CalcAbsTicks(Os_TickType baseTick, Os_TickType offset,
                                                  Os_CounterType CounterID);
extern FUNC(Os_TickType, OS_CODE) Os_GetDistance(Os_TickType baseTick, Os_TickType destTick,
                                                 Os_CounterType CounterID);
...
extern FUNC(void, OS_CODE) Os_InsertAlarm(Os_AlarmType alarmid, Os_AlarmRefType almque,
                                          Os_TickType curTick);
extern FUNC(void, OS_CODE) Os_DeleteAlarm(Os_AlarmType alarmid, Os_AlarmRefType almque);
...
extern FUNC(void, OS_CODE) Os_TmProtTaskStart(Os_TaskType osTaskId,
                                              Os_TmProtOptTaskType osOptType);
...
extern FUNC(void, OS_CODE) Os_TmProtResStart(ResourceType osResId,
                                             Os_TmProtResOccupyType osOccupyType);
...
/* Applicaiton. */
#if ((OS_SC3 == CFG_SC) || (OS_SC4 == CFG_SC))
extern FUNC(void, OS_CODE) Os_TerminateObjects(P2CONST(Os_ApplicationCfgType,
                                                       AUTOMATIC, OS_VAR) pOsCurAppCfg);
...
#if (CFG_ISR2_MAX > 0)
extern FUNC(void, OS_CODE) Os_SuspendOsInt(void);
extern FUNC(void, OS_CODE) Os_ResumeOsInt(void);
...
extern FUNC(void, OS_CODE) Os_InitCpuUsage(void);

extern FUNC(void, OS_CODE) Os_CpuUsageCalc(void);

extern FUNC(void, OS_CODE) Os_TaskUsageTimerStart(Os_TaskType taskId);

extern FUNC(void, OS_CODE) Os_TaskUsageTimerStop(Os_TaskType taskId);

extern FUNC(void, OS_CODE) Os_IsrUsageTimerStart(Os_IsrType isrId);

extern FUNC(void, OS_CODE) Os_IsrUsageTimerStop(Os_IsrType isrId);

extern FUNC(StatusType, OS_CODE) Os_GetTaskCpuUsage(Os_TaskType taskId, Os_ExcuteUsageTypeRef usage);

extern FUNC(StatusType, OS_CODE) Os_GetIsrCpuUsage(Os_TaskType isrId, Os_ExcuteUsageTypeRef usage);

extern FUNC(void, OS_CODE) Os_SetObjectStartPoint(void);

extern FUNC(void, OS_CODE) Os_SetObjectStopPoint(void);
