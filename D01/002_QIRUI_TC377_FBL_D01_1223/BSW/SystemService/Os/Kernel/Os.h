...
#endif /* #if (CFG_EXTENDED_TASK_MAX > 0U) */
...
#endif /* #if (TRUE == CFG_POSTTASKHOOK) */
 ...
 */
/******************************************************************************/
extern FUNC(AccessType, OS_CODE)CheckISRMemoryAccess
(
    ISRType                ISRID,
 ...
 */
/******************************************************************************/
extern FUNC(AccessType, OS_CODE)CheckTaskMemoryAccess
(
    TaskType               TaskID,
    MemoryStartAddressType Address,
    MemorySizeType         Size
...
#endif /* #if (CFG_TRUSTED_SYSTEM_SERVICE_MAX > 0U) */
 ...
 */
/******************************************************************************/
extern FUNC(StatusType, OS_CODE) Os_IocHLTransmit
(
 ...
 */
/******************************************************************************/
extern FUNC(StatusType, OS_CODE) Os_IocHLReceive
(
	Os_IocAbsIdType       absId,
	const Os_IocDataSourceType* pData
);
