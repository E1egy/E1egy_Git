...
VAR(boolean volatile, OS_VAR) 				Os_TrapWait = TRUE;
/* Used to compile abstractions.
...
static FUNC(void, OS_CODE) Os_InitSystem(void)
{
    ...
    /* Init Os_CoreCB, OS_CORE_ID_MASTER is auto start, don't by means of
     * StartCore.*/
	...
	Os_InitCpuUsage();
	#endif /*(CFG_GET_CPUUSAGE_ENABLE == TRUE)*/
 ...
 */
/******************************************************************************/
FUNC(void, OS_CODE) Os_ReadyQueueInsert
(
    Os_TaskType object,
...
{
    Os_TaskStateType tempState = TASK_STATE_SUSPENDED;
    Os_SCB.sysPrevTaskID = Os_SCB.sysRunningTaskID;
    #if (TRUE == CFG_STACK_CHECK)
    Os_StackPtrType StackPtr = NULL_PTR;
    #endif
    ...
    Os_SCB.sysRunningAppID
        = Os_ObjectAppCfg[OBJECT_TASK][Os_SCB.sysRunningTaskID].hostApp;
	...
	Os_TaskUsageTimerStop(Os_SCB.sysPrevTaskID);
	Os_TaskUsageTimerStart(Os_SCB.sysRunningTaskID);
	#endif
}
 ...
 */
/******************************************************************************/
static FUNC(Os_PriorityType, OS_CODE) Os_GetHighPrioBit
(
...
)
{
    ...
    /* DD_1_0149 */
    static CONST(uint8, OS_CONST) Os_MapTable[16] 
...
static FUNC(void, OS_CODE) Os_SynPoint(uint8 point)
{
    switch (point)
    {
        ...
        case 0:
            ...
            while ( Os_CoreCB.coreStateSynPoint0[0] == FALSE
                    #if (TRUE == CFG_CORE1_AUTOSAROS_ENABLE)
                    || Os_CoreCB.coreStateSynPoint0[1] == FALSE
                    #endif /* TRUE == CFG_CORE1_AUTOSAROS_ENABLE */
                    #if (TRUE == CFG_CORE2_AUTOSAROS_ENABLE)
                    || Os_CoreCB.coreStateSynPoint0[2] == FALSE
                    #endif /* TRUE == CFG_CORE2_AUTOSAROS_ENABLE */
                    )
            {
                /* Nothing to do. */
        ...
        case 1:
            ...
            while ( Os_CoreCB.coreStateSynPoint1[0] == FALSE
                    #if (TRUE == CFG_CORE1_AUTOSAROS_ENABLE)
                    || Os_CoreCB.coreStateSynPoint1[1] == FALSE
                    #endif /* TRUE == CFG_CORE1_AUTOSAROS_ENABLE */
                    #if (TRUE == CFG_CORE2_AUTOSAROS_ENABLE)
                    || Os_CoreCB.coreStateSynPoint1[2] == FALSE
                    #endif /* TRUE == CFG_CORE2_AUTOSAROS_ENABLE */
                    )
            {
                /* Nothing to do. */
        ...
        case 2:
            ...
            while ( Os_CoreCB.coreStateSynPoint2[0] == FALSE
                    #if (TRUE == CFG_CORE1_AUTOSAROS_ENABLE)
                    || Os_CoreCB.coreStateSynPoint2[1] == FALSE
                    #endif /* TRUE == CFG_CORE1_AUTOSAROS_ENABLE */
                    #if (TRUE == CFG_CORE2_AUTOSAROS_ENABLE)
                    || Os_CoreCB.coreStateSynPoint2[2] == FALSE
                    #endif /* TRUE == CFG_CORE2_AUTOSAROS_ENABLE */
                    )
            {
                /* Nothing to do. */
        ...
        case 3:
            ...
            while ( Os_CoreCB.coreStateSynPoint3[0] == FALSE
                    #if (TRUE == CFG_CORE1_AUTOSAROS_ENABLE)
                    || Os_CoreCB.coreStateSynPoint3[1] == FALSE
                    #endif /* TRUE == CFG_CORE1_AUTOSAROS_ENABLE */
                    #if (TRUE == CFG_CORE2_AUTOSAROS_ENABLE)
                    || Os_CoreCB.coreStateSynPoint3[2] == FALSE
                    #endif /* TRUE == CFG_CORE2_AUTOSAROS_ENABLE */
                    )
            {
                /* Nothing to do. */
...
static FUNC(void, OS_CODE) Os_DeInitCoreInfo(void)
{
    ...
    Os_CoreCB.coreStateActive   &= (Os_CoreIdType)(~((Os_CoreIdType)1 << Os_SCB.sysCore));
