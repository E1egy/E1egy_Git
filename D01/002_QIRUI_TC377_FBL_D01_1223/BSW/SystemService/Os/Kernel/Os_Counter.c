...
static VAR(Os_CounterType, OS_VAR)                      Os_CfgCounterMax = 0U;
...
{
    Os_CounterType i;
    P2VAR(Os_CCBType volatile, AUTOMATIC, OS_VAR) pCCB = NULL_PTR;
 ...
 */
/******************************************************************************/
FUNC(Os_TickType, OS_CODE) Os_CalcAbsTicks
(
...
)
{
    ...
    counterTwiceMaxTicks = (
            Os_CounterCfg[CounterID].osCounterMaxAllowedValue * 2u) + 1u;
 ...
 */
/******************************************************************************/
FUNC(Os_TickType, OS_CODE) Os_GetDistance
(
    Os_TickType baseTick,
