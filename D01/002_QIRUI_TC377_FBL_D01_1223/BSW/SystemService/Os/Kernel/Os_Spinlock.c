...
FUNC(StatusType, OS_CODE) GetSpinlock(SpinlockIdType SpinlockId)
{
    ...
    #endif /* #if (TRUE == CFG_SERVICE_PROTECTION_ENABLE) */
    {
        ...
        /*Os_00691*/
        else if ((OS_SPINLOCK_INVALID != Os_CoreCB.currentSpinlockOccupyLevel)
        ...
        {
            appCfgId = CheckObjectOwnership(Os_SLCB[SpinlockId].objOccupyType,
                    Os_SLCB[SpinlockId].objOccupyId);
...
FUNC(StatusType, OS_CODE) ReleaseSpinlock(SpinlockIdType SpinlockId)
{
    ...
    #endif /* #if (TRUE == CFG_SERVICE_PROTECTION_ENABLE) */
    {
        ...
        /*Os_00701*/
        else if (( SpinlockId != Os_CoreCB.currentSpinlockOccupyLevel)
        ...
        else if (OS_LEVEL_TASK == Os_SCB.sysOsLevel)
        {
            ...
            /*res and spinlock should together release as LIFO order*/
            #if (CFG_STD_RESOURCE_MAX > 0U)
            else if ((pTCB->taskCriticalZoneType[pTCB->taskCriticalZoneCount-1u] != OBJECT_SPINLOCK) ||
        ...
        else if (OS_LEVEL_ISR2 == Os_SCB.sysOsLevel)
        {
            ...
            /*res and spinlock should together release as LIFO order*/
            #if (CFG_STD_RESOURCE_MAX > 0U)
            else if ((pICB->isr2CriticalZoneType[pICB->isr2CriticalZoneCount-1u] != OBJECT_SPINLOCK)
