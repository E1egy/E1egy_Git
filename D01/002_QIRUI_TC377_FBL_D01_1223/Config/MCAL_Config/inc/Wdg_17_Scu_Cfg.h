...
#define WDG_17_SCU_SW_MAJOR_VERSION   (10U)
#define WDG_17_SCU_SW_MINOR_VERSION   (40U)
#define WDG_17_SCU_SW_PATCH_VERSION   (1U)
...
#define WDG_17_SCU_INIT_CHECK_API                                           (STD_ON)  
