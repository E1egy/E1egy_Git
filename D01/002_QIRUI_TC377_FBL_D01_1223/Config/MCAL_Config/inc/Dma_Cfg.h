...
#define DMA_SW_MAJOR_VERSION                (10U)
#define DMA_SW_MINOR_VERSION                (40U)
#define DMA_SW_PATCH_VERSION                (1U)
...
#define DMA_MULTICORE_ERROR_DETECT          (STD_ON)


/* Total number of DMA channels in core 0 */
#define DMA_ALLOCATED_CHANNELS_CORE0 (5U)
...
*/
#define DMA_INITCHECK_API                   (STD_OFF)
