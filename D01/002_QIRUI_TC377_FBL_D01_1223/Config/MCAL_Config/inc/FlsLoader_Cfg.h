...
**                                                                            **
**  DATE, TIME: 2023-04-04, 17:52:25              !!!IGNORE-LINE!!!           **
**                                                                            **
...
#define FLSLOADER_SW_MAJOR_VERSION       (10U)
#define FLSLOADER_SW_MINOR_VERSION       (40U)
#define FLSLOADER_SW_PATCH_VERSION       (1U)

#define FLSLOADER_NUM_OF_PFLASH_BANK     (2U)
...
#define FLSLOADER_DFLASH0_END            ((FlsLoader_AddressType)(0xaf03ffffU))
#define FLSLOADER_DFLASH0_BANK_SIZE      (0x40000U)
#define FLSLOADER_NUM_OF_DF0_SECTORS     (64U)
