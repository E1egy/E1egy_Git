...
#define NUM_OF_SECT_1   (16U)
#define BUFFER_SIZE1    (8192U) /* Number of bytes to be written */
...
static FlsLoader_ReturnType FlsLoader_lPFlashDemo(void)
{
  ...
  FlsLoader_Address=0xa0314000;
  {
    ...
    if(retval == FLSLOADER_E_OK)
    {
      ...
      print_f("\n Programming at the specified address \n");
      for(write_cnt=0;write_cnt<32;write_cnt++)
          retval = FlsLoader_Write((uint32)(FlsLoader_Address+write_cnt*0x2000), BUFFER_SIZE1, &buffer[0]);
