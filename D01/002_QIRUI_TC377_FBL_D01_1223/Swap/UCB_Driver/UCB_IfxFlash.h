...
#ifndef UCB_IFXFLAS_H
#define UCB_IFXFLAS_H 1
 ...
 * \return None
 */
IFX_INLINE void UCB_IfxFlash_clearStatus(uint32 flash);
 ...
 *
 * // enter page mode
 * UCB_IfxFlash_enterPageMode(pageAddr);
 *
 * \endcode
 *
 */
IFX_INLINE uint8 UCB_IfxFlash_enterPageMode(uint32 pageAddr);
 ...
 *  UCB_IfxFlash_eraseMultipleSectors(pFlashTableLog[sector].start,2);
 *
 * \endcode
 *
 */
IFX_INLINE void UCB_IfxFlash_eraseMultipleSectors(uint32 sectorAddr, uint32 numSector);
 ...
 *   // erase sector
 *  UCB_IfxFlash_eraseSector(sector_addr);
 * }
 *
 *
 * \endcode
 *
 */
IFX_INLINE void UCB_IfxFlash_eraseSector(uint32 sectorAddr);
 ...
 * \return None
 */
IFX_INLINE void UCB_IfxFlash_eraseVerifyMultipleSectors(uint32 sectorAddr, uint32 numSector);

/** \brief Performs the "Erase Verify" sequence
 * \param sectorAddr sector address which should be verified
 * \return None
 */
IFX_INLINE void UCB_IfxFlash_eraseVerifySector(uint32 sectorAddr);
 ...
 * UCB_IfxFlash_loadPage(IFXFLASH_PFLASH_START, 0x55555555, 0xaaaaaaaa);
 *
 * // load 64bit into assembly buffer of data flash
 * UCB_IfxFlash_loadPage(0XAF000000, 0x55555555, 0xaaaaaaaa);
 * \endcode
 *
 */
IFX_INLINE void UCB_IfxFlash_loadPage(uint32 pageAddr, uint32 wordL, uint32 wordU);
 ...
 * UCB_IfxFlash_loadPage2X32(IFXFLASH_PFLASH_START, 0x55555555, 0xaaaaaaaa);
 *
 * // load 2*32bit into assembly buffer of data flash
 * UCB_IfxFlash_loadPage2X32(0XAF000000, 0x55555555, 0xaaaaaaaa);
 * \endcode
 *
 */
IFX_INLINE void UCB_IfxFlash_loadPage2X32(uint32 pageAddr, uint32 wordL, uint32 wordU);
 ...
 *
 * // reset to read mode
 *  UCB_IfxFlash_resetToRead(0);
 *
 * \endcode
 *
 */
IFX_INLINE void UCB_IfxFlash_resetToRead(uint32 flash);

/** \brief Performs the "Resume Protection" sequence
 * \param flash selects the flash (PMU) module
 * \return None
 */
IFX_INLINE void UCB_IfxFlash_resumeProtection(uint32 flash);
 ...
 * \return None
 */
IFX_INLINE void UCB_IfxFlash_suspendResumeMultipleSectors(uint32 sectorAddr, uint32 numSector);

/** \brief Performs the "Suspend Resume" sequence
 * \param sectorAddr sector address which should be resumed
 * \return None
 */
IFX_INLINE void UCB_IfxFlash_suspendResumeSector(uint32 sectorAddr);
 ...
 * \return None
 */
IFX_INLINE void UCB_IfxFlash_userContentCount(uint32 wordAddr);
 ...
 * \return None
 */
IFX_INLINE void UCB_IfxFlash_userMarginCount(uint32 wordAddr);
 ...
 * \return None
 */
IFX_INLINE void UCB_IfxFlash_userVthCount(uint32 wordAddr);
 ...
 * \return None
 */
IFX_INLINE void UCB_IfxFlash_verifyErasedPage(uint32 pageAddr);
 ...
 * \return None
 */
IFX_INLINE void UCB_IfxFlash_verifyErasedWordLine(uint32 wordLineAddr);
 ...
 *  UCB_IfxFlash_waitUnbusy(0, IfxFlash_FlashType_D0);
 *
 * \endcode
 *
 */
IFX_INLINE uint8 UCB_IfxFlash_waitUnbusy(uint32 flash, IfxFlash_FlashType flashType);
 ...
 * UCB_IfxFlash_writeBurst(0xa0000100);
 *
 * \endcode
 *
 */
IFX_INLINE void UCB_IfxFlash_writeBurst(uint32 pageAddr);
 ...
 *
 * // program the second page of the first sector of the Program Flash
 * UCB_IfxFlash_writeBurstOnce(0xa0000100);
 *
 * \endcode
 *
 */
IFX_INLINE void UCB_IfxFlash_writeBurstOnce(uint32 pageAddr);
 ...
 *
 * // program the second page of the first sector of the Program Flash
 * UCB_IfxFlash_writePage(0xa0000100);
 *
 * \endcode
 *
 */
IFX_INLINE void UCB_IfxFlash_writePage(uint32 pageAddr);
 ...
 *
 * // program the second page of the first sector of the Program Flash
 * UCB_IfxFlash_writePageOnce(0xa0000100);
 *
 * \endcode
 *
 */
IFX_INLINE void UCB_IfxFlash_writePageOnce(uint32 pageAddr);
 ...
 * \return None
 */
IFX_EXTERN void UCB_IfxFlash_disableWriteProtection(uint32 flash, IfxFlash_UcbType ucb, uint32 *password);
 ...
 */
IFX_INLINE boolean UCB_IfxFlash_waitUnbusyAll(void);

/** \brief Enter Flash Cranking Mode.
 * \return None
 */
IFX_INLINE void UCB_IfxFlash_enterCrankingMode(void);

/** \brief Exit Flash Cranking Mode.
 * \return None
 */
IFX_INLINE void UCB_IfxFlash_exitCrankingMode(void);

/**
 * \return None
 */
IFX_INLINE void UCB_IfxFlash_enterDemandMode(void);

/**
 * \return None
 */
IFX_INLINE void UCB_IfxFlash_exitDemandMode(void);

/**
 * \return None
 */
IFX_INLINE void UCB_IfxFlash_enterDynamicIdleMode(void);

/**
 * \return None
 */
IFX_INLINE void UCB_IfxFlash_exitDynamicIdleMode(void);
 ...
 * FALSE - Flash is not in Cranking Mode
 */
IFX_INLINE boolean UCB_IfxFlash_isCrankingMode(void);
 ...
 * FALSE - Flash is not in Demand Mode
 */
IFX_INLINE boolean UCB_IfxFlash_isDemandMode(void);
 ...
 * FALSE - Flash is not in Dynamic Idle Mode
 */
IFX_INLINE boolean UCB_IfxFlash_isDynamicIdleMode(void);

/**
 * \param pageAddr start address of page which should be programmed
 * \return None
 */
IFX_INLINE void UCB_IfxFlash_replaceLogicalSector(uint32 pageAddr);

IFX_INLINE boolean UCB_IfxCpu_areInterruptsEnabled(void);

IFX_INLINE boolean UCB_IfxCpu_disableInterrupts(void);

IFX_INLINE void UCB_IfxCpu_enableInterrupts(void);

IFX_INLINE void UCB_IfxCpu_restoreInterrupts(boolean enabled);
