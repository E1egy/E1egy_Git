...
/***************** Static Global Constants Sections ************************/
  ...
  #ifdef _TASKING_C_TRICORE_
    #pragma section farrom  "Const.FlsCpu0.32bit"
    #pragma align 4
  #elif defined _GNU_C_TRICORE_
    #pragma section  "Const.FlsCpu0.32bit" a 4
   #elif defined _GHS_C_TRICORE_
     #pragma ghs section rodata = ".Const.FlsCpu0.32bit"
  #elif defined _DIABDATA_C_TRICORE_
    #pragma section CONST "Const.FlsCpu0.32bit" far-absolute R
  #endif
