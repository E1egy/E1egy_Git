...
{
#if 0 // no HSM
    0x007E,         /**< \brief 0x000: .bmi: Boot Mode Index (BMI)*/
    0xB359,         /**< \brief 0x002: .bmhdid: Boot Mode Header ID (CODE) = B359H*/
    0xA0000000,     /**< \brief 0x004: .stad: User Code start address*/
    0x809FE5E2,     /**< \brief 0x008: .crc: Check Result for the BMI Header (offset 000H - 007H)*/
    0x7F601A1D,     /**< \brief 0x00C: .crcInv: Inverted Check Result for the BMI Header (offset 000H - 007H)*/
#else // add HSM
    0x007E,         /**< \brief 0x000: .bmi: Boot Mode Index (BMI)*/
    0xB359,         /**< \brief 0x002: .bmhdid: Boot Mode Header ID (CODE) = B359H*/
    0xA0060024,     /**< \brief 0x004: .stad: User Code start address*/
    0xB8117D81,     /**< \brief 0x008: .crc: Check Result for the BMI Header (offset 000H - 007H)*/
    0x47EE827E,     /**< \brief 0x00C: .crcInv: Inverted Check Result for the BMI Header (offset 000H - 007H)*/
#endif
    {
