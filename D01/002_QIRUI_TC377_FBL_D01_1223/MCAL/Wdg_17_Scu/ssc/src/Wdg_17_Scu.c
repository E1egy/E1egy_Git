...
#if ( WDG_17_SCU_SW_MINOR_VERSION != 40U )
...
static Wdg_17_Scu_CoreStatusType* const
Wdg_17_Scu_Status[WDG_17_SCU_MAX_TIMERS] =
{
  #if (WDG_17_SCU_CONFIGURED_CORE0 == STD_ON)
  ...
  #endif
  {
    ...
    {      
      ...
      else
      {
        ...
        GtmChConfig = &(Wdg_ConfigPtr[CoreId]->WdgGtmTimerInfo[((uint32)Mode>>1U)&1U]);
...
(const WdgIf_ModeType Mode, const uint32 CoreId)
{
  ...
  else /* Mode is WDGIF_SLOW_MODE  or WDGIF_FAST_MODE */
  {
    ...
    /* [cover parentID={1AED1533-2D8B-48fd-8A48-67B5433DC239}]
...
(const WdgIf_ModeType Mode, const uint32 CoreId)
{
  ...
  switch(Mode)
  {
    ...
    /* [cover parentID={79BF59CC-199A-4177-BCE4-65DBC6E41A9E}]
      If Mode is SLOW[/cover] */
    ...
    /* [cover parentID={5A329614-235A-4be0-92C5-E7561F7E1BBE}]
    Fast mode?[/cover] */
    case WDGIF_FAST_MODE:
    {
      ...
      /* ATOM/TOM channel module is enabled*/
      /* check if it is TOM Channel */
      /* [cover parentID={BEC03542-39BA-4d91-8400-4FF7CD4263C6}]
        If the timer TOM?[/cover] */
      ...
      if(GtmChConfig->TimerType == MCU_GTM_TIMER_TOM)
      {
        ...
        Mcu_17_Gtm_TomChannelInit(&(Wdg_ConfigPtr[CoreId]->WdgGtmTimerInfo[1]));
        Mcu_17_Gtm_TomChannelShadowTransfer(GtmModuleNumber, GtmChannelNumber);
      ...
      if(ErrorFlag == (Std_ReturnType)E_OK)
      {
        ...
        if(Wdg_17_Scu_Status[CoreId]->Wdg_TimeoutCounter > 0x00U)
        {
              ...
              WDGIF_SLOW_MODE)
          {
            ...
            TimeOutCount = ((Wdg_ConfigPtr[CoreId]->SlowModeRefreshTime  
          ...
          else
          {
            ...
            /* [cover parentID={1BB008EB-ECCD-4540-8F56-D8846DB93F1A}]
                 Compare Register Value is calculated using FastModeRefreshTime
                 and timer resolution [/cover] */
            TimeOutCount =((Wdg_ConfigPtr[CoreId]->FastModeRefreshTime  
                            * WDT_TIMEOUT_FACTOR) / TimeOutResolution);
          }
      ...
      if(ErrorFlag == E_OK)
      {
        ...
        else
        {
          ...
          else
          {
            ...
            GtmChConfig = &(Wdg_ConfigPtr[CoreId]->WdgGtmTimerInfo[1]);
          }
